...
const weightUnits = {
  ...
  ton_us: { name: "US Ton", factor: 907185 },
}
...
export function WeightConverter() {
  ...
  const convert = () => {
    ...
    const result = (inputValue * weightUnits[fromUnit].factor) / weightUnits[toUnit].factor
      ...
      <CardContent className="p-0">
        <div className="grid gap-6 p-6">
          <div className="grid gap-2">
            ...
            <div className="grid grid-cols-3 gap-2">
              ...
              <Select value={fromUnit} onValueChange={setFromUnit}>
                ...
                <SelectContent>
                  {Object.entries(weightUnits).map(([unit, { name }]) => (
          ...
          <div className="text-sm text-muted-foreground">
            ...
            <p className="mt-1">
              1 {fromUnit} ={" "}
              {(weightUnits[fromUnit].factor / weightUnits[toUnit].factor).toFixed(6).replace(/\.?0+$/, "")} {toUnit}
            </p>
          </div>
        </div>
      </CardContent>
